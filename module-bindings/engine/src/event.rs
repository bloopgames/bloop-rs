...
pub mod graphics {
    ...
    impl<'a> DrawRectangle<'a> {
        ...
        pub const VT_ASSET_ID: flatbuffers::VOffsetT = 12;
        ...
        pub fn unpack(&self) -> DrawRectangleT {
            ...
            let size_ = self.size_().map(|x| x.unpack());
        ...
        #[inline]
        pub fn position(&self) -> Option<&'a super::Vec3> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab
                    .get::<super::Vec3>(DrawRectangle::VT_POSITION, None)
            }
        }
        #[inline]
        pub fn size_(&self) -> Option<&'a super::Vec2> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe { self._tab.get::<super::Vec2>(DrawRectangle::VT_SIZE_, None) }
        }
        #[inline]
        pub fn rotation(&self) -> Option<f32> {
            ...
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe { self._tab.get::<f32>(DrawRectangle::VT_ROTATION, None) }
        }
        #[inline]
    ...
    impl flatbuffers::Verifiable for DrawRectangle<'_> {
        ...
        fn run_verifier(
            ...
            use self::flatbuffers::Verifiable;
            v.visit_table(pos)?
                .visit_field::<super::Vec3>("position", Self::VT_POSITION, false)?
                .visit_field::<super::Vec2>("size_", Self::VT_SIZE_, false)?
    ...
    pub struct DrawRectangleArgs<'a> {
        pub position: Option<&'a super::Vec3>,
        pub size_: Option<&'a super::Vec2>,
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> DrawRectangleBuilder<'a, 'b, A> {
        #[inline]
        pub fn add_position(&mut self, position: &super::Vec3) {
            self.fbb_
                .push_slot_always::<&super::Vec3>(DrawRectangle::VT_POSITION, position);
        }
        #[inline]
        pub fn add_size_(&mut self, size_: &super::Vec2) {
            self.fbb_
                .push_slot_always::<&super::Vec2>(DrawRectangle::VT_SIZE_, size_);
        }
        #[inline]
        pub fn add_rotation(&mut self, rotation: f32) {
            self.fbb_
                .push_slot_always::<f32>(DrawRectangle::VT_ROTATION, rotation);
        }
        #[inline]
    ...
    pub struct DrawRectangleT {
        pub position: Option<super::Vec3T>,
        pub size_: Option<super::Vec2T>,
        pub rotation: Option<f32>,
    ...
    impl DrawRectangleT {
        pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
            ...
            let size__tmp = self.size_.as_ref().map(|x| x.pack());
    ...
    impl<'a> TextLoaded<'a> {
        pub const VT_ID: flatbuffers::VOffsetT = 4;
        pub const VT_ASSET_PATH: flatbuffers::VOffsetT = 6;
        pub const VT_RAW_TEXT: flatbuffers::VOffsetT = 8;
        pub const VT_FORMAT: flatbuffers::VOffsetT = 10;
        pub const VT_WATCHER_SET_UP: flatbuffers::VOffsetT = 12;
    ...
    pub struct TextReloadedArgs {
        pub id: u32,
    }
    impl<'a> Default for TextReloadedArgs {
        #[inline]
        fn default() -> Self {
            TextReloadedArgs { id: 0 }
        }
    }
    ...
    impl TextReloadedT {
        pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
            ...
            let id = self.id;
            TextReloaded::create(_fbb, &TextReloadedArgs { id })
        }
    }
